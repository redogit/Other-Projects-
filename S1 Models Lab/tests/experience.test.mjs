...
function input(actions=[{plane:'xw',degrees:1}],relations={familyId:'f0'}){return {initialState:geom.id,mirrorId:'mirror:'+geom.id,shell:'s3-sample',actions,observer:DEFAULT_OBSERVER,observerField:{version:'s1-observer-field/v0',taskVersion:'s1-observer-task/v0',densityId:'fixture',calibrations:[]},comparisons:{obligation:'live-vs-mirror'},relations,provenance:{source:'unit'}};}

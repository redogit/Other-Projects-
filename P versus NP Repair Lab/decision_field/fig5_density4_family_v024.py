...
FAMILY_VERSION = "FIG5-clause-priority-3cnf-density4/v0.24"
...
def describe_contract() -> dict:
    return {
        ...
        "realized_density_rule": "target_clause_count(n)/n; realized density is exactly 4 for every allowed n",
        ...
        "boundaries": [
            ...
            "DENSITY4_FROZEN != DENSITY35_PREDECESSOR",
